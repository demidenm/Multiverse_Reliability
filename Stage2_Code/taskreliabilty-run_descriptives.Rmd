...
```{r}
create_plot <- function(dataset, y_est, type, thresh, y_min, y_max, add_title = TRUE) {
  plot <- dataset %>%
...
by_sample_conmod <- function(dataset, y_est,y_min, y_max) {
...
subset <- by_sample_conmod(icc_subthresh, y_est = "median_est", y_min =-.1, y_max=.6)
fwhm_rg = create_plot(icc_subthresh, y_est = "median_est", type = "fwhm",  thresh = "sub-threshold", y_min=-.1, y_max=.6, add_title=FALSE)
motion_rg = create_plot(icc_subthresh, y_est = "median_est", type = "motion", thresh = "sub-threshold", y_min=-.1, y_max=.6, add_title=FALSE)
modeltype_rg = create_plot(icc_subthresh, y_est = "median_est", type = "model", thresh = "sub-threshold",y_min=-.1, y_max=.6, add_title=FALSE)
contrast_rg = create_plot(icc_subthresh, y_est = "median_est", type = "con", thresh = "sub-threshold", y_min=-.1, y_max=.6, add_title=FALSE)
...
```{r, fig.width=16, fig.height=10}
subset <- by_sample_conmod(icc_suprathresh, y_est = "median_est", y_min=-.1, y_max=.6)
fwhm_rg = create_plot(icc_suprathresh, y_est = "median_est", type = "fwhm",  thresh = "supra-threshold", y_min=-.1, y_max=.6, add_title=FALSE)
motion_rg = create_plot(icc_suprathresh, y_est = "median_est", type = "motion", thresh = "supra-threshold", y_min=-.1, y_max=.6, add_title=FALSE)
modeltype_rg = create_plot(icc_suprathresh, y_est = "median_est", type = "model", thresh = "supra-threshold",y_min=-.1, y_max=.6, add_title=FALSE)
contrast_rg = create_plot(icc_suprathresh, y_est = "median_est", type = "con", thresh = "supra-threshold", y_min=-.1, y_max=.6, add_title=FALSE)
...
```{r, fig.width=16, fig.height=10}
fwhm_rg = create_plot(icc_nacc, y_est = "avg_right", "fwhm","Avg Right NAcc", y_min=-.1, y_max=.6, add_title=FALSE)
motion_rg = create_plot(icc_nacc, y_est = "avg_right", "motion","Avg Right NAcc", y_min=-.1, y_max=.6, add_title=FALSE)
modeltype_rg = create_plot(icc_nacc, y_est = "avg_right", "model","Avg Right NAcc",y_min=-.1, y_max=.6, add_title=FALSE)
contrast_rg = create_plot(icc_nacc, y_est = "avg_right", "con","sAvg Right NAcc", y_min=-.1, y_max=.6, add_title=FALSE)
...
```{r, fig.width=16, fig.height=10}
fwhm_rg = create_plot(icc_nacc, y_est = "avg_left", "fwhm","Avg Left NAcc", y_min=-.1, y_max=.6, add_title=FALSE)
motion_rg = create_plot(icc_nacc, y_est = "avg_left", "motion","Avg Left NAcc", y_min=-.1, y_max=.6, add_title=FALSE)
modeltype_rg = create_plot(icc_nacc, y_est = "avg_left", "model","Avg Left NAcc",y_min=-.1, y_max=.6, add_title=FALSE)
contrast_rg = create_plot(icc_nacc, y_est = "avg_left", "con","sAvg Left NAcc", y_min=-.1, y_max=.6, add_title=FALSE)
...
```{r, fig.width=16, fig.height=10}
subset <- by_sample_conmod(bs_subthresh, y_est = "median_est", y_min=0, y_max=7)
fwhm_rg = create_plot(bs_subthresh, y_est = "median_est", type = "fwhm",  thresh = "sub-threshold", y_min=0, y_max=7, add_title=FALSE)
motion_rg = create_plot(bs_subthresh, y_est = "median_est", type = "motion", thresh = "sub-threshold", y_min=0, y_max=7, add_title=FALSE)
modeltype_rg = create_plot(bs_subthresh, y_est = "median_est", type = "model", thresh = "sub-threshold",y_min=0, y_max=7, add_title=FALSE)
contrast_rg = create_plot(bs_subthresh, y_est = "median_est", type = "con", thresh = "sub-threshold", y_min=0, y_max=7, add_title=FALSE)
...
```{r, fig.width=16, fig.height=10}
subset <- by_sample_conmod(bs_suprathresh, y_est = "median_est", y_min=0, y_max=7)
fwhm_rg = create_plot(bs_suprathresh, y_est = "median_est", type = "fwhm",  thresh = "supra-threshold", y_min=0, y_max=7, add_title=FALSE)
motion_rg = create_plot(bs_suprathresh, y_est = "median_est", type = "motion", thresh = "supra-threshold", y_min=0, y_max=7, add_title=FALSE)
modeltype_rg = create_plot(bs_suprathresh, y_est = "median_est", type = "model", thresh = "supra-threshold",y_min=0, y_max=7, add_title=FALSE)
contrast_rg = create_plot(bs_suprathresh, y_est = "median_est", type = "con", thresh = "supra-threshold", y_min=0, y_max=7, add_title=FALSE)
...
```{r, fig.width=16, fig.height=10}
subset <- by_sample_conmod(ws_subthresh, y_est = "median_est", y_min=0, y_max=7)
fwhm_rg = create_plot(ws_subthresh, y_est = "median_est", type = "fwhm",  thresh = "sub-threshold", y_min=0, y_max=7, add_title=FALSE)
motion_rg = create_plot(ws_subthresh, y_est = "median_est", type = "motion", thresh = "sub-threshold", y_min=0, y_max=7, add_title=FALSE)
modeltype_rg = create_plot(ws_subthresh, y_est = "median_est", type = "model", thresh = "sub-threshold",y_min=0, y_max=7, add_title=FALSE)
contrast_rg = create_plot(ws_subthresh, y_est = "median_est", type = "con", thresh = "sub-threshold", y_min=0, y_max=7, add_title=FALSE)
...
```{r, fig.width=16, fig.height=10}
subset <- by_sample_conmod(ws_suprathresh, y_est = "median_est", y_min=0, y_max=7)
fwhm_rg = create_plot(ws_suprathresh, y_est = "median_est", type = "fwhm",  thresh = "supra-threshold", y_min=0, y_max=7, add_title=FALSE)
motion_rg = create_plot(ws_suprathresh, y_est = "median_est", type = "motion", thresh = "supra-threshold", y_min=0, y_max=7, add_title=FALSE)
modeltype_rg = create_plot(ws_suprathresh, y_est = "median_est", type = "model", thresh = "supra-threshold",y_min=0, y_max=7, add_title=FALSE)
contrast_rg = create_plot(ws_suprathresh, y_est = "median_est", type = "con", thresh = "supra-threshold", y_min=0, y_max=7, add_title=FALSE)
...
```{r, fig.width=16, fig.height=10}
subset <- by_sample_conmod(similarity_df, y_est = "jaccard", y_min=0, y_max = 1)

fwhm_rg = create_plot(similarity_df, y_est = "jaccard", type = "fwhm", thresh = "Jaccard", y_min=0, y_max = 1, add_title=FALSE)
motion_rg = create_plot(similarity_df, y_est = "jaccard", type = "motion", thresh = "Jaccard", y_min=0, y_max = 1, add_title=FALSE)
modeltype_rg = create_plot(similarity_df, y_est = "jaccard", type = "model", thresh="Jaccrd", y_min=0, y_max = 1, add_title=FALSE)
contrast_rg = create_plot(similarity_df, y_est = "jaccard", type = "con", thresh = "Jaccard", y_min=0, y_max = 1, add_title=FALSE)
...
```{r, fig.width=16, fig.height=10}
subset <- by_sample_conmod(similarity_df, y_est = "spearman", y_min=0, y_max = 1)

fwhm_rg = create_plot(similarity_df, y_est = "spearman", type = "fwhm", thresh = "Spearman", y_min=0, y_max = 1, add_title=FALSE)
motion_rg = create_plot(similarity_df, y_est = "spearman", type = "motion", thresh = "Spearman", y_min=0, y_max = 1, add_title=FALSE)
modeltype_rg = create_plot(similarity_df, y_est = "spearman", type = "model", thresh="Spearman", y_min=0, y_max = 1, add_title=FALSE)
contrast_rg = create_plot(similarity_df, y_est = "spearman", type = "con", thresh = "Spearman", y_min=0, y_max = 1, add_title=FALSE)
...
```{r, fig.width=16, fig.height=10}
subset <- by_sample_conmod(efficiency_df, y_est = "eff_est", y_min = 0, y_max = 15)
motion_rg = create_plot(efficiency_df, y_est = "eff_est", "motion","Efficiency", y_min = 0, y_max = 15, add_title=FALSE)
modeltype_rg = create_plot(efficiency_df, y_est = "eff_est", "model","Efficiency", y_min = 0, y_max = 15,add_title=FALSE)
contrast_rg = create_plot(efficiency_df, y_est = "eff_est", "con","Efficiency", y_min = 0, y_max = 15,  add_title=FALSE)
