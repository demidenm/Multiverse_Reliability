...
fwhm_rg = create_plot(similarity_df, y_est = "spearman", type = "fwhm", thresh = "Jaccard", y_min=0, y_max = 1, add_title=FALSE)
motion_rg = create_plot(similarity_df, y_est = "spearman", type = "motion", thresh = "Jaccard", y_min=0, y_max = 1, add_title=FALSE)
modeltype_rg = create_plot(similarity_df, y_est = "spearman", type = "model", thresh="Jaccrd", y_min=0, y_max = 1, add_title=FALSE)
contrast_rg = create_plot(similarity_df, y_est = "spearman", type = "con", thresh = "Jaccard", y_min=0, y_max = 1, add_title=FALSE)
